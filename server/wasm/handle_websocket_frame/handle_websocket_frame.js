 ...
 * @returns {any}
 */
module.exports.handle_websocket_frame = function(data) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.handle_websocket_frame(ptr0, len0);
...
const path = require('path').join(__dirname, 'handle_websocket_frame_bg.wasm');
